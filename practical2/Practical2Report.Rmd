...
We can see that the estimated intercept and slope are reasonably close to the true parameter, 3 and 0.5.
...
Our final artificial dataset is sampled from the model $$ Y_j \quad = \quad 100 - 20 x_j  + x_j^2 + \epsilon_j,$$ where $\epsilon_1, \ldots, \epsilon_{100}$ are iid $N(0, 400)$.
...
Consider $$ Y_j \quad = \quad \beta_0 + \beta_1 x_{j} + \beta_2\, x_{j}^2 + \epsilon_j, \qquad j = 1, \ldots, n. $$ One unit change of $x_j$ will affect both $\beta_1$ and $\beta_2$. Hence $\beta_1$ and $\beta_2$ should not be interpreted individually.
