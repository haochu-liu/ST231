...
\begin{align*}
\log(\widehat{\texttt{price}_i}) = &\hat\beta_0 + \hat\beta_1 \log(\texttt{c_carat}_i) + \hat\beta_2 1(\texttt{clarity}_i = \texttt{VS1}) + \hat\beta_3 1(\texttt{clarity}_i = \texttt{VVS2})\\
&+ \hat\beta_4 1(\texttt{clarity}_i = \texttt{VVS1}) + \hat\beta_5 1(\texttt{clarity}_i = \texttt{IF})
\end{align*}
$$
...
\begin{align*}
\log(\widehat{\texttt{price}_i}) = &\hat\beta_1 \log(\texttt{c_carat}_i) + \hat\beta_2 1(\texttt{clarity}_i = \texttt{VS2}) + \hat\beta_3 1(\texttt{clarity}_i = \texttt{VS1})\\
&+ \hat\beta_4 1(\texttt{clarity}_i = \texttt{VVS2}) + \hat\beta_5 1(\texttt{clarity}_i = \texttt{VVS1}) + \hat\beta_6 1(\texttt{clarity}_i = \texttt{IF})
\end{align*}
$$
